package io.java.application.web.rest;

import io.java.application.config.Constants;
import io.java.application.JavaApp;
import io.java.application.domain.Authority;
import io.java.application.domain.User;
import io.java.application.repository.AuthorityRepository;
import io.java.application.repository.UserRepository;
import io.java.application.security.AuthoritiesConstants;
import io.java.application.service.MailService;
import io.java.application.service.dto.UserDTO;
import io.java.application.web.rest.errors.ExceptionTranslator;
import io.java.application.web.rest.vm.KeyAndPasswordVM;
import io.java.application.web.rest.vm.ManagedUserVM;
import io.java.application.service.UserService;
...
@SpringBootTest(classes = JavaApp.class)
