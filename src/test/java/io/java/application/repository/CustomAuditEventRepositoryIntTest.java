package io.java.application.repository;

import io.java.application.JavaApp;
import io.java.application.config.Constants;
import io.java.application.config.audit.AuditEventConverter;
import io.java.application.domain.PersistentAuditEvent;
...
import static io.java.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
